                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="sku_code" value="{{$product->sku_code}}" id="sku_code" required />
                                    </div>
                                    ...
                                    <div class="col-6 mb-3">
                                        ...
                                        <input type="number" class="form-control" name="qty" value="{{$product->qty}}" id="qty" required />
                                    </div>

                                    <div class="col-6 mb-3">
                                        <label for="buying_price" class="form-label">Product Buying Price*</label>
                                        <input type="number" class="form-control" name="buying_price" value="{{$product->buying_price}}" id="buying_price" required />
                                    </div>

                                    <div class="col-6 mb-3">
                                        <label for="regular_price" class="form-label">Product Regular Price*</label>
                                        <input type="number" class="form-control" name="regular_price" value="{{$product->regular_price}}" id="regular_price" required />
                                    </div>
